class State {
    constructor(display, actors, platforms) {
    ...
    update(time) {
      ...
      const platforms = this.platforms.map(actor => {
        return actor.update(this, time, updateId);
      });
...
const collidingBalls = ({ width = 640, height = 480, parent = document.getElementById("gameDiv"), count = 2 } = {}) => {
    ...
    let state = new State(display, balls, platforms);
    runAnimation(time => {
